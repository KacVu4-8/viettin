...
import './quytrinhKN.css'
import { LazyLoadImage } from "react-lazy-load-image-component";
import "react-lazy-load-image-component/src/effects/blur.css";

import bg from "../../../assets/Quytrình/KN/bg.jpg";
import kn from "../../../assets/Quytrình/KN/quytrinhkn.png";
import diengiai from "../../../assets/Quytrình/KN/diengiai.png";
            ...
            <div className="text-white max-w-6xl">
              <div className="flex flex-row gap-1 pb-4">
                <a className="font-semibold text-lg lg:text-xl">
                  <b className="text-blue-200">Quy trình Khiếu Nại</b>
                </a>
