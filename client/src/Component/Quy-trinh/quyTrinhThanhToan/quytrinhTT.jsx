...
import "./quytrinhTT.css";
import { LazyLoadImage } from "react-lazy-load-image-component";
import "react-lazy-load-image-component/src/effects/blur.css";

import bg from "../../../assets/Quytrình/TT/bg.jpg";
import tt from "../../../assets/Quytrình/TT/quytrinhtt.png";
import diengiai from "../../../assets/Quytrình/TT/diengiai.png";
            ...
            <div className="text-white max-w-6xl">
              <div className="flex flex-row gap-1 pb-4">
                <a className="font-semibold text-lg lg:text-xl">
                  <b className="text-blue-200">Quy trình Thanh toán</b>
                </a>
              ...
              <div>
                <span className="text-3xl lg:text-5xl leading-[1.2em] font-extrabold">
                  QUY TRÌNH THANH QUYẾT TOÁN, ĐỐI CHIẾU CÔNG NỢ
                </span>
              </div>
            </div>
          </div>
